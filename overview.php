            ...
            <div class="widget-box-content padded-for-scroll" data-simplebar>
              ...
              <div class="user-status-list scroll-content">
                ...
                <div class="user-status notification">
                  ...
                  <!-- USER STATUS TITLE -->
                  <p class="user-status-title"><a class="bold" href="profile-timeline.php">Nick Grissom</a> shared your <a class="highlighted" href="profile-timeline.php">status update</a></p>
                  <!-- /USER STATUS TITLE -->
          ...
          <div class="widget-box-content padded-for-scroll medium" data-simplebar>
            ...
            <div class="user-status-list scroll-content">
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Marina Valentine</a> left a love <img class="reaction" src="img/reaction/love.png" alt="reaction-love"> reaction on <a class="highlighted" href="profile-timeline.php">Destroy Dex</a>'s <a class="highlighted" href="profile-timeline.php">status update</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Marina Valentine</a> updated her <a class="highlighted" href="profile-photos.php">profile picture</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Marina Valentine</a> left a happy <img class="reaction" src="img/reaction/happy.png" alt="reaction-happy"> reaction on <a class="highlighted" href="profile-timeline.php">Neko Bebop</a>'s <a class="highlighted" href="profile-timeline.php">status update</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Marina Valentine</a> commented on <a class="highlighted" href="profile-timeline.php">Sarah Diamond</a>'s <a class="highlighted" href="profile-photos.php">photo</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Marina Valentine</a> posted a new <a class="highlighted" href="profile-timeline.php">status update</a> "Hi to all! Remember"</p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Marina Valentine</a> replied to a <a class="highlighted" href="profile-timeline.php">Damian Greyson</a>'s <a class="highlighted" href="profile-timeline.php">comment</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Marina Valentine</a> shared <a class="highlighted" href="profile-timeline.php">Destroy Dex</a>'s <a class="highlighted" href="profile-timeline.php">status update</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Marina Valentine</a> left a wow! <img class="reaction" src="img/reaction/wow.png" alt="reaction-wow"> reaction on <a class="highlighted" href="profile-timeline.php">Destroy Dex</a>'s <a class="highlighted" href="profile-timeline.php">status update</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Marina Valentine</a> updated her <a class="highlighted" href="profile-timeline.php">cover picture</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Marina Valentine</a> left a like <img class="reaction" src="img/reaction/like.png" alt="reaction-like"> reaction on <a class="highlighted" href="profile-timeline.php">Nick Grissom</a>'s <a class="highlighted" href="profile-timeline.php">status update</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Marina Valentine</a> left a funny <img class="reaction" src="img/reaction/funny.png" alt="reaction-funny"> reaction on <a class="highlighted" href="profile-timeline.php">Bearded Wonder</a>'s <a class="highlighted" href="profile-timeline.php">status update</a></p>
                <!-- /USER STATUS TITLE -->
    ...
    <div class="grid">
      ...
      <div class="grid grid-half change-on-desktop">
        ...
        <div class="achievement-box secondary">
          ...
          <!-- BUTTON -->
          <a class="button white-solid" href="badges.php">Browse All</a>
          <!-- /BUTTON -->
        </div>
        <!-- /ACHIEVEMENT BOX -->
        ...
        <div class="achievement-box primary">
          ...
          <!-- BUTTON -->
          <a class="button white-solid" href="quests.php">Browse All</a>
          <!-- /BUTTON -->
        </div>
        <!-- /ACHIEVEMENT BOX -->
      </div>
