  ...
  <div class="content-grid">
    ...
    <nav class="section-navigation">
      ...
      <div id="section-navigation-slider" class="section-menu">
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="profile-timeline.php">
          <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item active" href="profile-forum.php">
          <!-- SECTION MENU ITEM ICON -->
        ...
        <div class="table-body">
          ...
          <div class="table-row medium">
            ...
            <div class="table-column">
              ...
              <div class="discussion-preview">
                ...
                <a class="discussion-preview-title" href="forums-discussion.php">The recent issue of "Darkman" features a new masked hero</a>
                <!-- /DISCUSSION PREVIEW TITLE -->
                ...
                <div class="discussion-preview-meta">
                  ...
                  <!-- DISCUSSION PREVIEW META TEXT -->
                  <p class="discussion-preview-meta-text"><a href="profile-timeline.php">Marina Valentine</a> 22 minutes ago<span class="separator">-</span><a class="highlighted" href="forums-category.php">Comics</a></p>
                  <!-- /DISCUSSION PREVIEW META TEXT -->
                </div>
                <!-- /DISCUSSION PREVIEW META -->
              </div>
          ...
          <div class="table-row medium">
            ...
            <div class="table-column">
              ...
              <div class="discussion-preview">
                <!-- DISCUSSION PREVIEW TITLE -->
                <a class="discussion-preview-title" href="forums-discussion.php">I played the new "Monstermon: Vibranium" and it's awesome!</a>
                <!-- /DISCUSSION PREVIEW TITLE -->
                ...
                <div class="discussion-preview-meta">
                  ...
                  <!-- DISCUSSION PREVIEW META TEXT -->
                  <p class="discussion-preview-meta-text"><a href="profile-timeline.php">Marina Valentine</a> 6 hours ago<span class="separator">-</span><a class="highlighted" href="forums-category.php">The Arcade</a></p>
                  <!-- /DISCUSSION PREVIEW META TEXT -->
                </div>
                <!-- /DISCUSSION PREVIEW META -->
              </div>
          ...
          <div class="table-row medium">
            ...
            <div class="table-column">
              ...
              <div class="discussion-preview">
                <!-- DISCUSSION PREVIEW TITLE -->
                <a class="discussion-preview-title" href="forums-discussion.php">What do you like and dislike about the new forum looks?</a>
                <!-- /DISCUSSION PREVIEW TITLE -->
                ...
                <div class="discussion-preview-meta">
                  ...
                  <!-- DISCUSSION PREVIEW META TEXT -->
                  <p class="discussion-preview-meta-text"><a href="profile-timeline.php">Marina Valentine</a> 1 day ago<span class="separator">-</span><a class="highlighted" href="forums-category.php">Community Hangout</a></p>
                  <!-- /DISCUSSION PREVIEW META TEXT -->
                </div>
                <!-- /DISCUSSION PREVIEW META -->
              </div>
          ...
          <div class="table-row medium">
            ...
            <div class="table-column">
              ...
              <div class="discussion-preview">
                <!-- DISCUSSION PREVIEW TITLE -->
                <a class="discussion-preview-title" href="forums-discussion.php">Let's post photos of our workspaces!</a>
                <!-- /DISCUSSION PREVIEW TITLE -->
                ...
                <div class="discussion-preview-meta">
                  ...
                  <!-- DISCUSSION PREVIEW META TEXT -->
                  <p class="discussion-preview-meta-text"><a href="profile-timeline.php">Marina Valentine</a> 3 days ago<span class="separator">-</span><a class="highlighted" href="forums-category.php">Community Hangout</a></p>
                  <!-- /DISCUSSION PREVIEW META TEXT -->
                </div>
                <!-- /DISCUSSION PREVIEW META -->
              </div>
          ...
          <div class="table-row medium">
            ...
            <div class="table-column">
              ...
              <div class="discussion-preview">
                <!-- DISCUSSION PREVIEW TITLE -->
                <a class="discussion-preview-title" href="forums-discussion.php">The new "Dragon Adventure" manga answers what happened with Spike</a>
                <!-- /DISCUSSION PREVIEW TITLE -->
                ...
                <div class="discussion-preview-meta">
                  ...
                  <!-- DISCUSSION PREVIEW META TEXT -->
                  <p class="discussion-preview-meta-text"><a href="profile-timeline.php">Marina Valentine</a> 1 week ago<span class="separator">-</span><a class="highlighted" href="forums-category.php">Anime &amp; Manga</a></p>
                  <!-- /DISCUSSION PREVIEW META TEXT -->
                </div>
                <!-- /DISCUSSION PREVIEW META -->
              </div>
