...
<body>
  ...
  <nav id="navigation-widget-small" class="navigation-widget navigation-widget-desktop closed sidebar left delayed">
    <!-- USER AVATAR -->
    <a class="user-avatar small no-outline online" href="profile-timeline.php">
      <!-- USER AVATAR CONTENT -->
    ...
    <ul class="menu small">
      ...
      <li class="menu-item">
        <!-- MENU ITEM LINK -->
        <a class="menu-item-link text-tooltip-tfr" href="newsfeed.php" data-title="Newsfeed">
          <!-- MENU ITEM LINK ICON -->
      ...
      <li class="menu-item">
        <!-- MENU ITEM LINK -->
        <a class="menu-item-link text-tooltip-tfr" href="overview.php" data-title="Overview">
          <!-- MENU ITEM LINK ICON -->
      ...
      <li class="menu-item">
        <!-- MENU ITEM LINK -->
        <a class="menu-item-link text-tooltip-tfr" href="groups.php" data-title="Groups">
          <!-- MENU ITEM LINK ICON -->
      ...
      <li class="menu-item">
        <!-- MENU ITEM LINK -->
        <a class="menu-item-link text-tooltip-tfr" href="badges.php" data-title="Badges">
          <!-- MENU ITEM LINK ICON -->
      ...
      <li class="menu-item">
        <!-- MENU ITEM LINK -->
        <a class="menu-item-link text-tooltip-tfr" href="quests.php" data-title="Quests">
          <!-- MENU ITEM LINK ICON -->
      ...
      <li class="menu-item">
        <!-- MENU ITEM LINK -->
        <a class="menu-item-link text-tooltip-tfr" href="streams.php" data-title="Streams">
          <!-- MENU ITEM LINK ICON -->
      ...
      <li class="menu-item">
        <!-- MENU ITEM LINK -->
        <a class="menu-item-link text-tooltip-tfr" href="forums.php" data-title="Forums">
          <!-- MENU ITEM LINK ICON -->
      ...
      <li class="menu-item">
        <!-- MENU ITEM LINK -->
        <a class="menu-item-link text-tooltip-tfr" href="marketplace.php" data-title="Marketplace">
          <!-- MENU ITEM LINK ICON -->
  ...
  <nav id="navigation-widget" class="navigation-widget navigation-widget-desktop sidebar left hidden" data-simplebar>
    ...
    <div class="user-short-description">
      ...
      <a class="user-short-description-avatar user-avatar medium" href="profile-timeline.php">
        <!-- USER AVATAR BORDER -->
      ...
      <p class="user-short-description-title"><a href="profile-timeline.php">Marina Valentine</a></p>
      <!-- /USER SHORT DESCRIPTION TITLE -->
    ...
    <div class="badge-list small">
      ...
      <!-- BADGE ITEM -->
      <a class="badge-item" href="profile-badges.php">
    ...
    <ul class="menu">
      ...
      <li class="menu-item">
        <!-- MENU ITEM LINK -->
        <a class="menu-item-link" href="newsfeed.php">
          <!-- MENU ITEM LINK ICON -->
          <svg class="menu-item-link-icon icon-newsfeed">
            <use xlink:href="#svg-newsfeed"></use>
          </svg>
      ...
      <li class="menu-item">
        <!-- MENU ITEM LINK -->
        <a class="menu-item-link" href="overview.php">
          <!-- MENU ITEM LINK ICON -->
          <svg class="menu-item-link-icon icon-overview">
            <use xlink:href="#svg-overview"></use>
          </svg>
      ...
      <li class="menu-item">
        <!-- MENU ITEM LINK -->
        <a class="menu-item-link" href="groups.php">
          <!-- MENU ITEM LINK ICON -->
          <svg class="menu-item-link-icon icon-group">
            <use xlink:href="#svg-group"></use>
          </svg>
      ...
      <li class="menu-item">
        <!-- MENU ITEM LINK -->
        <a class="menu-item-link" href="badges.php">
          <!-- MENU ITEM LINK ICON -->
          <svg class="menu-item-link-icon icon-badges">
            <use xlink:href="#svg-badges"></use>
          </svg>
      ...
      <li class="menu-item">
        <!-- MENU ITEM LINK -->
        <a class="menu-item-link" href="quests.php">
          <!-- MENU ITEM LINK ICON -->
          <svg class="menu-item-link-icon icon-quests">
            <use xlink:href="#svg-quests"></use>
          </svg>
      ...
      <li class="menu-item">
        <!-- MENU ITEM LINK -->
        <a class="menu-item-link" href="streams.php">
          <!-- MENU ITEM LINK ICON -->
          <svg class="menu-item-link-icon icon-streams">
            <use xlink:href="#svg-streams"></use>
          </svg>
      ...
      <li class="menu-item">
        <!-- MENU ITEM LINK -->
        <a class="menu-item-link" href="forums.php">
          <!-- MENU ITEM LINK ICON -->
          <svg class="menu-item-link-icon icon-forums">
            <use xlink:href="#svg-forums"></use>
          </svg>
      ...
      <li class="menu-item">
        <!-- MENU ITEM LINK -->
        <a class="menu-item-link" href="marketplace.php">
          <!-- MENU ITEM LINK ICON -->
          <svg class="menu-item-link-icon icon-marketplace">
            <use xlink:href="#svg-marketplace"></use>
          </svg>
  ...
  <nav id="navigation-widget-mobile" class="navigation-widget navigation-widget-mobile sidebar left hidden" data-simplebar>
    ...
    <div class="navigation-widget-info-wrap">
      ...
      <div class="navigation-widget-info">
        <!-- USER AVATAR -->
        <a class="user-avatar small no-outline" href="profile-timeline.php">
          <!-- USER AVATAR CONTENT -->
          <div class="user-avatar-content">
            <!-- HEXAGON -->
            <div class="hexagon-image-30-32" data-src="img/avatar/01.jpg"></div>
        ...
        <p class="navigation-widget-info-title"><a href="profile-timeline.php">Marina Valentine</a></p>
        <!-- /NAVIGATION WIDGET INFO TITLE -->
    ...
    <a class="navigation-widget-section-link" href="hub-profile-info.php">Profile Info</a>
    <!-- /NAVIGATION WIDGET SECTION LINK -->

    <!-- NAVIGATION WIDGET SECTION LINK -->
    <a class="navigation-widget-section-link" href="hub-profile-social.php">Social &amp; Stream</a>
    <!-- /NAVIGATION WIDGET SECTION LINK -->

    <!-- NAVIGATION WIDGET SECTION LINK -->
    <a class="navigation-widget-section-link" href="hub-profile-notifications.php">Notifications</a>
    <!-- /NAVIGATION WIDGET SECTION LINK -->

    <!-- NAVIGATION WIDGET SECTION LINK -->
    <a class="navigation-widget-section-link" href="hub-profile-messages.php">Messages</a>
    <!-- /NAVIGATION WIDGET SECTION LINK -->

    <!-- NAVIGATION WIDGET SECTION LINK -->
    <a class="navigation-widget-section-link" href="hub-profile-requests.php">Friend Requests</a>
    <!-- /NAVIGATION WIDGET SECTION LINK -->
    ...
    <!-- NAVIGATION WIDGET SECTION LINK -->
    <a class="navigation-widget-section-link" href="hub-account-info.php">Account Info</a>
    <!-- /NAVIGATION WIDGET SECTION LINK -->

    <!-- NAVIGATION WIDGET SECTION LINK -->
    <a class="navigation-widget-section-link" href="hub-account-password.php">Change Password</a>
    <!-- /NAVIGATION WIDGET SECTION LINK -->

    <!-- NAVIGATION WIDGET SECTION LINK -->
    <a class="navigation-widget-section-link" href="hub-account-settings.php">General Settings</a>
    <!-- /NAVIGATION WIDGET SECTION LINK -->
    ...
    <!-- NAVIGATION WIDGET SECTION LINK -->
    <a class="navigation-widget-section-link" href="hub-group-management.php">Manage Groups</a>
    <!-- /NAVIGATION WIDGET SECTION LINK -->

    <!-- NAVIGATION WIDGET SECTION LINK -->
    <a class="navigation-widget-section-link" href="hub-group-invitations.php">Invitations</a>
    <!-- /NAVIGATION WIDGET SECTION LINK -->
    ...
    <!-- NAVIGATION WIDGET SECTION LINK -->
    <a class="navigation-widget-section-link" href="hub-store-account.php">My Account <span class="highlighted">$250,32</span></a>
    <!-- /NAVIGATION WIDGET SECTION LINK -->

    <!-- NAVIGATION WIDGET SECTION LINK -->
    <a class="navigation-widget-section-link" href="hub-store-statement.php">Sales Statement</a>
    <!-- /NAVIGATION WIDGET SECTION LINK -->

    <!-- NAVIGATION WIDGET SECTION LINK -->
    <a class="navigation-widget-section-link" href="hub-store-items.php">Manage Items</a>
    <!-- /NAVIGATION WIDGET SECTION LINK -->

    <!-- NAVIGATION WIDGET SECTION LINK -->
    <a class="navigation-widget-section-link" href="hub-store-downloads.php">Downloads</a>
    <!-- /NAVIGATION WIDGET SECTION LINK -->
    ...
    <div class="header-actions search-bar">
      ...
      <div class="dropdown-box padding-bottom-small header-search-dropdown">
        ...
        <div class="dropdown-box-list small no-scroll">
          ...
          <a class="dropdown-box-list-item" href="profile-timeline.php">
            <!-- USER STATUS -->
        ...
        <div class="dropdown-box-list small no-scroll">
          <!-- DROPDOWN BOX LIST ITEM -->
          <a class="dropdown-box-list-item" href="group-timeline.php">
            <!-- USER STATUS -->
            <div class="user-status notification">
              <!-- USER STATUS AVATAR -->
              <div class="user-status-avatar">
        ...
        <div class="dropdown-box-list small no-scroll">
          <!-- DROPDOWN BOX LIST ITEM -->
          <a class="dropdown-box-list-item" href="marketplace-product.php">
            <!-- USER STATUS -->
    ...
    <div class="header-actions">
      ...
      <div class="action-list dark">
          ...
          <div class="dropdown-box no-padding-bottom header-dropdown">
            ...
            <div class="dropdown-box-list scroll-small no-hover" data-simplebar>
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="cart-item-preview">
                  ...
                  <a class="cart-item-preview-image" href="marketplace-product.php">
                    <!-- PICTURE -->
                  ...
                  <p class="cart-item-preview-title"><a href="marketplace-product.php">Twitch Stream UI Pack</a></p>
                  <!-- /CART ITEM PREVIEW TITLE -->
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="cart-item-preview">
                  ...
                  <!-- CART ITEM PREVIEW TITLE -->
                  <p class="cart-item-preview-title"><a href="marketplace-product.php">Gaming Coin Badges Pack</a></p>
                  <!-- /CART ITEM PREVIEW TITLE -->
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="cart-item-preview">
                  ...
                  <!-- CART ITEM PREVIEW TITLE -->
                  <p class="cart-item-preview-title"><a href="marketplace-product.php">Generic Joystick Pack</a></p>
                  <!-- /CART ITEM PREVIEW TITLE -->
            ...
            <div class="dropdown-box-actions">
              ...
              <div class="dropdown-box-action">
                <!-- BUTTON -->
                <a class="button secondary" href="marketplace-cart.php">Shopping Cart</a>
                <!-- /BUTTON -->
              </div>
              <!-- /DROPDOWN BOX ACTION -->
              ...
              <div class="dropdown-box-action">
                <!-- BUTTON -->
                <a class="button primary" href="marketplace-checkout.php">Go to Checkout</a>
                <!-- /BUTTON -->
              </div>
              <!-- /DROPDOWN BOX ACTION -->
            </div>
        ...
        <div class="action-list-item-wrap">
          ...
          <div class="dropdown-box header-dropdown">
            ...
            <div class="dropdown-box-list no-hover" data-simplebar>
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="user-status request">
                  <!-- USER STATUS AVATAR -->
                  <a class="user-status-avatar" href="profile-timeline.php">
                    <!-- USER AVATAR -->
                    <div class="user-avatar small no-outline">
                      <!-- USER AVATAR CONTENT -->
                      <div class="user-avatar-content">
                  ...
                  <!-- USER STATUS TITLE -->
                  <p class="user-status-title"><a class="bold" href="profile-timeline.php">Ginny Danvers</a></p>
                  <!-- /USER STATUS TITLE -->
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="user-status request">
                  ...
                  <!-- USER STATUS TITLE -->
                  <p class="user-status-title"><a class="bold" href="profile-timeline.php">Paul Lang</a></p>
                  <!-- /USER STATUS TITLE -->
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="user-status request">
                  ...
                  <!-- USER STATUS TITLE -->
                  <p class="user-status-title"><a class="bold" href="profile-timeline.php">Cassie May</a></p>
                  <!-- /USER STATUS TITLE -->
            ...
            <!-- DROPDOWN BOX BUTTON -->
            <a class="dropdown-box-button secondary" href="hub-profile-requests.php">View all Requests</a>
            <!-- /DROPDOWN BOX BUTTON -->
          </div>
          <!-- /DROPDOWN BOX -->
        </div>
        ...
        <div class="action-list-item-wrap">
          ...
          <div class="dropdown-box header-dropdown">
            ...
            <div class="dropdown-box-list medium" data-simplebar>
              <!-- DROPDOWN BOX LIST ITEM -->
              <a class="dropdown-box-list-item" href="hub-profile-messages.php">
                <!-- USER STATUS -->
                <div class="user-status">
                  <!-- USER STATUS AVATAR -->
                  <div class="user-status-avatar">
            ...
            <!-- DROPDOWN BOX BUTTON -->
            <a class="dropdown-box-button primary" href="hub-profile-messages.php">View all Messages</a>
            <!-- /DROPDOWN BOX BUTTON -->
          </div>
          <!-- /DROPDOWN BOX -->
        </div>
        ...
        <div class="action-list-item-wrap">
          ...
          <div class="dropdown-box header-dropdown">
            ...
            <div class="dropdown-box-list" data-simplebar>
              ...
              <div class="dropdown-box-list-item unread">
                ...
                <div class="user-status notification">
                  ...
                  <!-- USER STATUS TITLE -->
                  <p class="user-status-title"><a class="bold" href="profile-timeline.php">Nick Grissom</a> posted a comment on your <a class="highlighted" href="profile-timeline.php">status update</a></p>
                  <!-- /USER STATUS TITLE -->
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="user-status notification">
                  ...
                  <!-- USER STATUS TITLE -->
                  <p class="user-status-title"><a class="bold" href="profile-timeline.php">Sarah Diamond</a> left a like <img class="reaction" src="img/reaction/like.png" alt="reaction-like"> reaction on your <a class="highlighted" href="profile-timeline.php">status update</a></p>
                  <!-- /USER STATUS TITLE -->
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="user-status notification">
                  ...
                  <!-- USER STATUS TITLE -->
                  <p class="user-status-title"><a class="bold" href="profile-timeline.php">Destroy Dex</a> posted a comment on your <a class="highlighted" href="profile-photos.php">photo</a></p>
                  <!-- /USER STATUS TITLE -->
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="user-status notification">
                  ...
                  <!-- USER STATUS TITLE -->
                  <p class="user-status-title"><a class="bold" href="profile-timeline.php">The Green Goo</a> left a love <img class="reaction" src="img/reaction/love.png" alt="reaction-love"> reaction on your <a class="highlighted" href="profile-timeline.php">status update</a></p>
                  <!-- /USER STATUS TITLE -->
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="user-status notification">
                  ...
                  <!-- USER STATUS TITLE -->
                  <p class="user-status-title"><a class="bold" href="profile-timeline.php">Neko Bebop</a> posted a comment on your <a class="highlighted" href="profile-timeline.php">status update</a></p>
                  <!-- /USER STATUS TITLE -->
            ...
            <!-- DROPDOWN BOX BUTTON -->
            <a class="dropdown-box-button secondary" href="hub-profile-notifications.php">View all Notifications</a>
            <!-- /DROPDOWN BOX BUTTON -->
          </div>
          <!-- /DROPDOWN BOX -->
        </div>
      ...
      <div class="action-item-wrap">
        ...
        <div class="dropdown-navigation header-settings-dropdown">
          ...
          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-profile-social.php">Social &amp; Stream</a>
          <!-- /DROPDOWN NAVIGATION LINK -->
      
          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-profile-notifications.php">Notifications</a>
          <!-- /DROPDOWN NAVIGATION LINK -->
      
          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-profile-messages.php">Messages</a>
          <!-- /DROPDOWN NAVIGATION LINK -->
      
          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-profile-requests.php">Friend Requests</a>
          <!-- /DROPDOWN NAVIGATION LINK -->
          ...
          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-account-info.php">Account Info</a>
          <!-- /DROPDOWN NAVIGATION LINK -->
      
          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-account-password.php">Change Password</a>
          <!-- /DROPDOWN NAVIGATION LINK -->
      
          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-account-settings.php">General Settings</a>
          <!-- /DROPDOWN NAVIGATION LINK -->
          ...
          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-group-management.php">Manage Groups</a>
          <!-- /DROPDOWN NAVIGATION LINK -->
      
          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-group-invitations.php">Invitations</a>
          <!-- /DROPDOWN NAVIGATION LINK -->
          ...
          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-store-account.php">My Account <span class="highlighted">$250,32</span></a>
          <!-- /DROPDOWN NAVIGATION LINK -->
      
          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-store-statement.php">Sales Statement</a>
          <!-- /DROPDOWN NAVIGATION LINK -->
      
          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-store-items.php">Manage Items</a>
          <!-- /DROPDOWN NAVIGATION LINK -->
      
          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-store-downloads.php">Downloads</a>
          <!-- /DROPDOWN NAVIGATION LINK -->
  ...
  <aside class="floaty-bar">
    ...
    <div class="bar-actions">
      ...
      <div class="action-list dark">
        <!-- ACTION LIST ITEM -->
        <a class="action-list-item" href="marketplace-cart.php">
          <!-- ACTION LIST ITEM ICON -->
          <svg class="action-list-item-icon icon-shopping-bag">
            <use xlink:href="#svg-shopping-bag"></use>
          </svg>
        ...
        <!-- ACTION LIST ITEM -->
        <a class="action-list-item" href="hub-profile-requests.php">
          <!-- ACTION LIST ITEM ICON -->
          <svg class="action-list-item-icon icon-friend">
            <use xlink:href="#svg-friend"></use>
          </svg>
        ...
        <!-- ACTION LIST ITEM -->
        <a class="action-list-item" href="hub-profile-messages.php">
          <!-- ACTION LIST ITEM ICON -->
          <svg class="action-list-item-icon icon-messages">
            <use xlink:href="#svg-messages"></use>
          </svg>
        ...
        <!-- ACTION LIST ITEM -->
        <a class="action-list-item unread" href="hub-profile-notifications.php">
          <!-- ACTION LIST ITEM ICON -->
          <svg class="action-list-item-icon icon-notification">
            <use xlink:href="#svg-notification"></use>
          </svg>
      ...
      <!-- ACTION ITEM WRAP -->
      <a class="action-item-wrap" href="hub-profile-info.php">
        <!-- ACTION ITEM -->
  ...
  <div class="content-grid">
    ...
    <div class="profile-header">
      ...
      <div class="profile-header-info">
        ...
        <div class="user-short-description big">
          <!-- USER SHORT DESCRIPTION AVATAR -->
          <a class="user-short-description-avatar user-avatar big" href="profile-timeline.php">
            <!-- USER AVATAR BORDER -->
            <div class="user-avatar-border">
              <!-- HEXAGON -->
          ...
          <!-- USER SHORT DESCRIPTION AVATAR -->
          <a class="user-short-description-avatar user-short-description-avatar-mobile user-avatar medium" href="profile-timeline.php">
            <!-- USER AVATAR BORDER -->
            <div class="user-avatar-border">
              <!-- HEXAGON -->
              <div class="hexagon-120-132"></div>
    ...
    <nav class="section-navigation">
      ...
      <div id="section-navigation-slider" class="section-menu">
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="profile-about.php">
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item active" href="profile-timeline.php">
          <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="profile-friends.php">
          <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="profile-groups.php">
          <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="profile-photos.php">
          <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="profile-videos.php">
          <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="profile-badges.php">
          <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="profile-stream.php">
          <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="profile-blog.php">
          <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="profile-forum.php">
          <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="profile-store.php">
          <!-- SECTION MENU ITEM ICON -->
    ...
    <div class="grid grid-3-6-3 mobile-prefer-content">
      ...
      <div class="grid-column">
        ...
        <div class="widget-box">
          ...
          <div class="widget-box-content">
            ...
            <div class="user-status-list">
              ...
              <div class="user-status request-small">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Sarah Diamond</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status request-small">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Nick Grissom</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status request-small">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Destroy Dex</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status request-small">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Neko Bebop</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status request-small">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">The Green Goo</a></p>
                <!-- /USER STATUS TITLE -->
          ...
          <!-- WIDGET BOX BUTTON -->
          <a class="widget-box-button button small secondary" href="profile-friends.php">See all Friends</a>
          <!-- /WIDGET BOX BUTTON -->
        </div>
        <!-- /WIDGET BOX -->
        ...
        <div class="widget-box">
          ...
          <div class="widget-box-content">
            ...
            <div class="post-peek-list">
              ...
              <div class="post-peek">
                <!-- POST PEEK IMAGE -->
                <a class="post-peek-image" href="profile-post.php">
                  <figure class="picture small round liquid">
                ...
                <!-- POST PEEK TITLE -->
                <p class="post-peek-title"><a href="profile-post.php">Here's the how and why did I became a full time Gaming Streamer</a></p>
                <!-- /POST PEEK TITLE -->
              ...
              <div class="post-peek">
                ...
                <!-- POST PEEK TITLE -->
                <p class="post-peek-title"><a href="profile-post.php">I spoke with the developers of RoBot SaMurai II at the 2019 GamingCon</a></p>
                <!-- /POST PEEK TITLE -->
              ...
              <div class="post-peek">
                ...
                <!-- POST PEEK TITLE -->
                <p class="post-peek-title"><a href="profile-post.php">I will be at this month's StreamCon with NekoBebop</a></p>
                <!-- /POST PEEK TITLE -->
              ...
              <div class="post-peek">
                ...
                <!-- POST PEEK TITLE -->
                <p class="post-peek-title"><a href="profile-post.php">[Exclusive!] Check out all the new missions and story of the Fire Witch DLC!</a></p>
                <!-- /POST PEEK TITLE -->
              ...
              <div class="post-peek">
                ...
                <!-- POST PEEK TITLE -->
                <p class="post-peek-title"><a href="profile-post.php">Old Super Mochi's Island is getting a remake!</a></p>
                <!-- /POST PEEK TITLE -->
          ...
          <div class="widget-box-status">
            ...
            <div class="widget-box-status-content">
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title medium"><a class="bold" href="profile-timeline.php">Marina Valentine</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <p class="widget-box-status-text">Hi to all! Remember that today I'll be livestreaming along with <a href="profile-timeline.php">@NekoBebop</a> the new character of the brand new Xenowatch patch "Anya Darkness". See you there!</p>
              <!-- /WIDGET BOX STATUS TEXT -->
              ...
              <div class="tag-list">
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Stream</a>
                <!-- /TAG ITEM -->

                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Xenowatch</a>
                <!-- /TAG ITEM -->

                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Gaming</a>
                <!-- /TAG ITEM -->

                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Twitch</a>
                <!-- /TAG ITEM -->
              </div>
              <!-- /TAG LIST -->
        ...
        <div class="widget-box no-padding">
          ...
          <div class="widget-box-status">
            ...
            <div class="widget-box-status-content">
              ...
              <div class="tag-list">
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Cover</a>
                <!-- /TAG ITEM -->
      
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Preview</a>
                <!-- /TAG ITEM -->
      
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Art</a>
                <!-- /TAG ITEM -->
      
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Machine</a>
                <!-- /TAG ITEM -->
      
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Wasteland</a>
                <!-- /TAG ITEM -->
              </div>
              <!-- /TAG LIST -->
          ...
          <div class="post-comment-list">
            ...
            <div class="post-comment">
              ...
              <!-- POST COMMENT TEXT -->
              <p class="post-comment-text"><a class="post-comment-text-author" href="profile-timeline.php">Neko Bebop</a>It's always a pleasure to do this streams with you! If we have at least half the fun than last time it will be an incredible success!</p>
              <!-- /POST COMMENT TEXT -->
            ...
            <div class="post-comment unread reply-2">
              ...
              <!-- POST COMMENT TEXT -->
              <p class="post-comment-text"><a class="post-comment-text-author" href="profile-timeline.php">Nick Grissom</a>I wouldn't miss it for anything!! Love both streams!</p>
              <!-- /POST COMMENT TEXT -->
            ...
            <div class="post-comment">
              ...
              <!-- POST COMMENT TEXT -->
              <p class="post-comment-text"><a class="post-comment-text-author" href="profile-timeline.php">Destroy Dex</a>YEAHHH!! <a href="profile-timeline.php">@MarinaValentine</a> I really enjoyed your last stream and it also was really funny! Can't wait!</p>
              <!-- /POST COMMENT TEXT -->
            ...
            <div class="post-comment">
              ...
              <!-- POST COMMENT TEXT -->
              <p class="post-comment-text"><a class="post-comment-text-author" href="profile-timeline.php">Sarah Diamond</a>That sounds awesome Marina! And also thanks a lot for the art sneak peek! I went to the GameCon last week and had a great time playing the game's open demo.</p>
              <!-- /POST COMMENT TEXT -->
        ...
        <div class="widget-box no-padding">
          ...
          <div class="widget-box-status">
            ...
            <div class="widget-box-status-content">
              ...
              <!-- WIDGET BOX STATUS TEXT -->
              <p class="widget-box-status-text">Tomorow I'll be livestreaming along with <a href="profile-timeline.php">@DestroyDex</a> on my Youtube channel. We are gonna do a spedrun of Super Mochi Bros 3!</p>
              <!-- /WIDGET BOX STATUS TEXT -->
              ...
              <div class="tag-list">
                ...
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Youtube</a>
                <!-- /TAG ITEM -->
                ...
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Retro</a>
                <!-- /TAG ITEM -->
              </div>
              <!-- /TAG LIST -->
          ...
          <div class="widget-box-status">
            ...
            <div class="widget-box-status-content">
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title medium"><a class="bold" href="profile-timeline.php">Marina Valentine</a> wrote a <span class="bold">Blog Post</span></p>
                <!-- /USER STATUS TITLE -->
            ...
            <div class="post-preview medium">
              ...
              <div class="post-preview-info">
                ...
                <!-- POST PREVIEW LINK -->
                <a class="post-preview-link" href="profile-post.php">Read more...</a>
                <!-- /POST PREVIEW LINK -->
              </div>
              <!-- /POST PREVIEW INFO -->
            </div>
            ...
            <div class="widget-box-status-content">
              ...
              <div class="tag-list">
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Streamer</a>
                <!-- /TAG ITEM -->
                ...
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Job</a>
                <!-- /TAG ITEM -->
      
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Life</a>
                <!-- /TAG ITEM -->
      
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Experience</a>
                <!-- /TAG ITEM -->
              </div>
              <!-- /TAG LIST -->
          ...
          <div class="widget-box-content small-margin-top">
            ...
            <div class="stream-box no-video-radius">
              ...
              <div class="stream-box-info">
                <!-- STREAM BOX TITLE -->
                <p class="stream-box-title"><a href="profile-stream.php">I'm Playing Athena’s Goddess Story...</a></p>
                <!-- /STREAM BOX TITLE -->
        ...
        <div class="widget-box">
          ...
          <div class="widget-box-content">
            ...
            <div class="picture-item-list small">
              ...
              <!-- PICTURE ITEM -->
              <a class="picture-item" href="profile-photos.php">
                <!-- PICTURE -->
                <figure class="picture round liquid">
        ...
        <div class="widget-box">
          ...
          <div class="widget-box-content">
            ...
            <div class="user-status-list">
              ...
              <div class="user-status request-small">
                <!-- USER STATUS AVATAR -->
                <a class="user-status-avatar" href="group-timeline.php">
                  <!-- USER AVATAR -->
                  <div class="user-avatar small no-border">
                    <!-- USER AVATAR CONTENT -->
                    <div class="user-avatar-content">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="group-timeline.php">Twitch Streamers</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status request-small">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="group-timeline.php">Cosplayers of the World</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status request-small">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="group-timeline.php">Stream Designers</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status request-small">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="group-timeline.php">Street Artists</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status request-small">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="group-timeline.php">Gaming Watchtower</a></p>
                <!-- /USER STATUS TITLE -->
        ...
        <div class="widget-box">
          ...
          <div class="widget-box-content">
            ...
            <div class="product-preview small">
              ...
              <a href="marketplace-product.php">
              ...
              <div class="product-preview-info">
                ...
                <p class="product-preview-title"><a href="marketplace-product.php">Twitch Stream UI Pack</a></p>
                <!-- /PRODUCT PREVIEW TITLE -->
          
                <!-- PRODUCT PREVIEW CATEGORY -->
                <p class="product-preview-category digital"><a href="marketplace-category.php">Stream Packs</a></p>
                <!-- /PRODUCT PREVIEW CATEGORY -->
              </div>
              <!-- /PRODUCT PREVIEW INFO -->
            </div>
