  ...
  <div class="content-grid">
    ...
    <nav class="section-navigation">
      ...
      <div id="section-navigation-slider" class="section-menu">
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item active" href="profile-groups.php">
          <!-- SECTION MENU ITEM ICON -->
      ...
      <div class="section-filters-bar v1">
        ...
        <div class="section-filters-bar-actions">
          ...
          <div class="view-actions">
            <!-- VIEW ACTION -->
            <a class="view-action text-tooltip-tft-medium active" href="profile-groups.php" data-title="Big Grid">
              <!-- VIEW ACTION ICON -->
            ...
            <!-- VIEW ACTION -->
            <a class="view-action text-tooltip-tft-medium" href="profile-groups-small-grid.php" data-title="Small Grid">
              <!-- VIEW ACTION ICON -->
            ...
            <!-- VIEW ACTION -->
            <a class="view-action text-tooltip-tft-medium" href="profile-groups-list.php" data-title="List">
              <!-- VIEW ACTION ICON -->
      ...
      <div class="grid grid-4-4-4 centered">
        ...
        <div class="user-preview">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description">
              <!-- USER SHORT DESCRIPTION AVATAR -->
              <a class="user-short-description-avatar user-avatar medium no-stats" href="group-timeline.php">
                <!-- USER AVATAR BORDER -->
                <div class="user-avatar-border">
                  <!-- HEXAGON -->
        ...
        <div class="user-preview">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description">
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="group-timeline.php">Twitch Streamers</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
        ...
        <div class="user-preview">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description">
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="group-timeline.php">Stream Designers</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
        ...
        <div class="user-preview">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description">
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="group-timeline.php">Street Artists</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
        ...
        <div class="user-preview">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description">
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="group-timeline.php">Gaming Watchtower</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
        ...
        <div class="user-preview">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description">
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="group-timeline.php">Retro Arcade</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
        ...
        <div class="user-preview">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description">
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="group-timeline.php">Living in Japan</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
