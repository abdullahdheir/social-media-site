      ...
      <div class="post-open-body">
        ...
        <div id="comments" class="post-comment-list">
          ...
          <div class="post-comment">
            ...
            <!-- POST COMMENT TEXT -->
            <p class="post-comment-text"><a class="post-comment-text-author" href="profile-timeline.php">Bearded Wonder</a>It's really inspiring to read about this and how you managed to get all up and running! Super awesome! Congratz <a href="profile-timeline.php">@MarinaValentine</a>!</p>
            <!-- /POST COMMENT TEXT -->
          ...
          <div class="post-comment unread reply-2">
            ...
            <!-- POST COMMENT TEXT -->
            <p class="post-comment-text"><a class="post-comment-text-author" href="profile-timeline.php">The Green Goo</a>Yeah!! Totally agree!</p>
            <!-- /POST COMMENT TEXT -->
          ...
          <div class="post-comment">
            ...
            <!-- POST COMMENT TEXT -->
            <p class="post-comment-text"><a class="post-comment-text-author" href="profile-timeline.php">Nick Grissom</a>I also started streaming with a simmilar game! I'm very excited to see what's next on your streams and for your next projects</p>
            <!-- /POST COMMENT TEXT -->
      ...
      <div class="post-preview">
        ...
        <div class="content-actions">
          ...
          <div class="content-action">
            ...
            <div class="meta-line">
              <!-- META LINE LINK -->
              <a class="meta-line-link" href="profile-post.php#comments">8 Comments</a>
              <!-- /META LINE LINK -->
            </div>
            <!-- /META LINE -->
      ...
      <div class="post-preview">
        ...
        <div class="content-actions">
          ...
          <div class="content-action">
            ...
            <div class="meta-line">
              <!-- META LINE LINK -->
              <a class="meta-line-link" href="profile-post.php#comments">2 Comments</a>
              <!-- /META LINE LINK -->
            </div>
            <!-- /META LINE -->
