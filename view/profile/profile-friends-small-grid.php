  ...
  <div class="content-grid">
    ...
    <nav class="section-navigation">
      ...
      <div id="section-navigation-slider" class="section-menu">
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item active" href="profile-friends.php">
          <!-- SECTION MENU ITEM ICON -->
      ...
      <div class="section-filters-bar v1">
        ...
        <div class="section-filters-bar-actions">
          ...
          <div class="view-actions">
            <!-- VIEW ACTION -->
            <a class="view-action text-tooltip-tft-medium" href="profile-friends.php" data-title="Big Grid">
              <!-- VIEW ACTION ICON -->
            ...
            <!-- VIEW ACTION -->
            <a class="view-action text-tooltip-tft-medium active" href="profile-friends-small-grid.php" data-title="Small Grid">
              <!-- VIEW ACTION ICON -->
            ...
            <!-- VIEW ACTION -->
            <a class="view-action text-tooltip-tft-medium" href="profile-friends-list.php" data-title="List">
              <!-- VIEW ACTION ICON -->
        ...
        <div class="user-preview small">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description small">
              <!-- USER SHORT DESCRIPTION AVATAR -->
              <a class="user-short-description-avatar user-avatar" href="profile-timeline.php">
                <!-- USER AVATAR BORDER -->
                <div class="user-avatar-border">
                  <!-- HEXAGON -->
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="profile-timeline.php">NekoBebop</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
        ...
        <div class="user-preview small">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description small">
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="profile-timeline.php">Destroy Dex</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
        ...
        <div class="user-preview small">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description small">
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="profile-timeline.php">Nick Grissom</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
        ...
        <div class="user-preview small">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description small">
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="profile-timeline.php">Sarah Diamond</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
        ...
        <div class="user-preview small">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description small">
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="profile-timeline.php">Bearded Wonder</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
        ...
        <div class="user-preview small">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description small">
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="profile-timeline.php">The Green Goo</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
        ...
        <div class="user-preview small">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description small">
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="profile-timeline.php">Damian Greyson</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
        ...
        <div class="user-preview small">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description small">
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="profile-timeline.php">Rosie Sakura</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
        ...
        <div class="user-preview small">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description small">
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="profile-timeline.php">Sarah Rodgers</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
        ...
        <div class="user-preview small">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description small">
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="profile-timeline.php">James Murdock</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
        ...
        <div class="user-preview small">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description small">
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="profile-timeline.php">Sandra Strange</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
        ...
        <div class="user-preview small">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description small">
              ...
              <!-- USER SHORT DESCRIPTION TITLE -->
              <p class="user-short-description-title"><a href="profile-timeline.php">Mark Wilson</a></p>
              <!-- /USER SHORT DESCRIPTION TITLE -->
