      ...
      <div class="section-filters-bar v1">
        ...
        <div class="section-filters-bar-actions">
          ...
          <div class="view-actions">
            ...
            <!-- VIEW ACTION -->
            <a class="view-action text-tooltip-tft-medium" href="profile-friends-small-grid.php" data-title="Small Grid">
              <!-- VIEW ACTION ICON -->
            ...
            <!-- VIEW ACTION -->
            <a class="view-action text-tooltip-tft-medium active" href="profile-friends-list.php" data-title="List">
              <!-- VIEW ACTION ICON -->
        ...
        <div class="user-preview landscape">
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description landscape tiny">
              <!-- USER SHORT DESCRIPTION AVATAR -->
              <a class="user-short-description-avatar user-avatar small" href="profile-timeline.php">
                <!-- USER AVATAR BORDER -->
                <div class="user-avatar-border">
                  <!-- HEXAGON -->
