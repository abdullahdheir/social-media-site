  ...
  <div class="content-grid">
    ...
    <nav class="section-navigation">
      ...
      <div id="section-navigation-slider" class="section-menu">
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item active" href="profile-photos.php">
          <!-- SECTION MENU ITEM ICON -->
    ...
    <section class="section">
      ...
      <div class="section-header">
        ...
        <div class="section-header-actions">
          ...
          <!-- SECTION HEADER ACTION -->
          <a class="section-header-action" href="profile-photos-inside.php">See All</a>
          <!-- /SECTION HEADER ACTION -->
        </div>
        <!-- /SECTION HEADER ACTIONS -->
      </div>
      ...
      <div class="grid grid-3-3-3-3 centered">
        <!-- ALBUM PREVIEW -->
        <a class="album-preview" href="profile-photos-inside.php">
          <!-- ALBUM PREVIEW IMAGE -->
