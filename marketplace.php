...
<body>
  ...
  <div class="content-grid">
    ...
    <div class="grid grid-3-3-3-3 centered">
      ...
      <a class="product-category-box category-all" href="marketplace-category.php">
      ...
      <!-- PRODUCT CATEGORY BOX -->
      <a class="product-category-box category-featured" href="marketplace-category.php">
        <!-- PRODUCT CATEGORY BOX TITLE -->
      ...
      <!-- PRODUCT CATEGORY BOX -->
      <a class="product-category-box category-digital" href="marketplace-category.php">
        <!-- PRODUCT CATEGORY BOX TITLE -->
      ...
      <!-- PRODUCT CATEGORY BOX -->
      <a class="product-category-box category-physical" href="marketplace-category.php">
        <!-- PRODUCT CATEGORY BOX TITLE -->
    ...
    <div class="section-header">
      ...
      <div class="section-header-actions">
        ...
        <a class="section-header-action" href="marketplace-category.php">Browse All Latest</a>
        <!-- /SECTION HEADER ACTION -->
      </div>
      <!-- /SECTION HEADER ACTIONS -->
    </div>
    ...
    <div class="grid grid-3-3-3-3 centered">
      ...
      <div class="product-preview">
        ...
        <div class="product-preview-meta">
          ...
          <div class="product-preview-author">
            ...
            <a class="product-preview-author-image user-avatar micro no-border" href="profile-timeline.php">
              <!-- USER AVATAR CONTENT -->
              <div class="user-avatar-content">
                <!-- HEXAGON -->
            ...
            <p class="product-preview-author-text"><a href="profile-timeline.php">Marina Valentine</a></p>
            <!-- /PRODUCT PREVIEW AUTHOR TEXT -->
          </div>
          <!-- /PRODUCT PREVIEW AUTHOR -->
      ...
      <div class="product-preview">
        ...
        <div class="product-preview-info">
          ...
          <!-- PRODUCT PREVIEW TITLE -->
          <p class="product-preview-title"><a href="marketplace-product.php">Jaxxy Witch Black Frame</a></p>
          <!-- /PRODUCT PREVIEW TITLE -->
    
          <!-- PRODUCT PREVIEW CATEGORY -->
          <p class="product-preview-category physical"><a href="marketplace-category.php">Art Prints</a></p>
          <!-- /PRODUCT PREVIEW CATEGORY -->
        ...
        <div class="product-preview-meta">
          ...
          <div class="product-preview-author">
            ...
            <!-- PRODUCT PREVIEW AUTHOR TEXT -->
            <p class="product-preview-author-text"><a href="profile-timeline.php">Neko Bebop</a></p>
            <!-- /PRODUCT PREVIEW AUTHOR TEXT -->
          </div>
          <!-- /PRODUCT PREVIEW AUTHOR -->
      ...
      <div class="product-preview">
        ...
        <div class="product-preview-info">
          ...
          <!-- PRODUCT PREVIEW TITLE -->
          <p class="product-preview-title"><a href="marketplace-product.php">Flaming Skull Team Logo</a></p>
          <!-- /PRODUCT PREVIEW TITLE -->
    
          <!-- PRODUCT PREVIEW CATEGORY -->
          <p class="product-preview-category digital"><a href="marketplace-category.php">Logos &amp; Badges</a></p>
          <!-- /PRODUCT PREVIEW CATEGORY -->
      ...
      <div class="product-preview">
        ...
        <div class="product-preview-info">
          ...
          <!-- PRODUCT PREVIEW TITLE -->
          <p class="product-preview-title"><a href="marketplace-product.php">Carbon Black Joystick</a></p>
          <!-- /PRODUCT PREVIEW TITLE -->
    
          <!-- PRODUCT PREVIEW CATEGORY -->
          <p class="product-preview-category physical"><a href="marketplace-category.php">Electronics</a></p>
          <!-- /PRODUCT PREVIEW CATEGORY -->
        ...
        <div class="product-preview-meta">
          ...
          <div class="product-preview-author">
            ...
            <!-- PRODUCT PREVIEW AUTHOR TEXT -->
            <p class="product-preview-author-text"><a href="profile-timeline.php">Bearded Wonder</a></p>
            <!-- /PRODUCT PREVIEW AUTHOR TEXT -->
          </div>
          <!-- /PRODUCT PREVIEW AUTHOR -->
      ...
      <div class="product-preview">
        ...
        <div class="product-preview-info">
          ...
          <!-- PRODUCT PREVIEW TITLE -->
          <p class="product-preview-title"><a href="marketplace-product.php">Emerald Dragon Digital Marketpl...</a></p>
          <!-- /PRODUCT PREVIEW TITLE -->
    
          <!-- PRODUCT PREVIEW CATEGORY -->
          <p class="product-preview-category digital"><a href="marketplace-category.php">HTML Templates</a></p>
          <!-- /PRODUCT PREVIEW CATEGORY -->
      ...
      <div class="product-preview">
        ...
        <div class="product-preview-info">
          ...
          <!-- PRODUCT PREVIEW TITLE -->
          <p class="product-preview-title"><a href="marketplace-product.php">Crimson Red Joystick</a></p>
          <!-- /PRODUCT PREVIEW TITLE -->
      ...
      <div class="product-preview">
        ...
        <div class="product-preview-info">
          ...
          <!-- PRODUCT PREVIEW TITLE -->
          <p class="product-preview-title"><a href="marketplace-product.php">Mercenaries White Frame</a></p>
          <!-- /PRODUCT PREVIEW TITLE -->
      ...
      <div class="product-preview">
        ...
        <div class="product-preview-info">
          ...
          <!-- PRODUCT PREVIEW TITLE -->
          <p class="product-preview-title"><a href="marketplace-product.php">People Illustrations Pack 02</a></p>
          <!-- /PRODUCT PREVIEW TITLE -->
    
          <!-- PRODUCT PREVIEW CATEGORY -->
          <p class="product-preview-category digital"><a href="marketplace-category.php">Illustrations</a></p>
          <!-- /PRODUCT PREVIEW CATEGORY -->
        ...
        <div class="product-preview-meta">
          ...
          <div class="product-preview-author">
            ...
            <!-- PRODUCT PREVIEW AUTHOR TEXT -->
            <p class="product-preview-author-text"><a href="profile-timeline.php">Destroy Dex</a></p>
            <!-- /PRODUCT PREVIEW AUTHOR TEXT -->
          </div>
          <!-- /PRODUCT PREVIEW AUTHOR -->
      ...
      <div class="product-preview">
        ...
        <div class="product-preview-info">
          ...
          <!-- PRODUCT PREVIEW TITLE -->
          <p class="product-preview-title"><a href="marketplace-product.php">People Illustrations Pack 01</a></p>
          <!-- /PRODUCT PREVIEW TITLE -->
      ...
      <div class="product-preview">
        ...
        <div class="product-preview-info">
          ...
          <!-- PRODUCT PREVIEW TITLE -->
          <p class="product-preview-title"><a href="marketplace-product.php">Pixel Diamond Gaming Magazine</a></p>
          <!-- /PRODUCT PREVIEW TITLE -->
      ...
      <div class="product-preview">
        ...
        <div class="product-preview-info">
          ...
          <!-- PRODUCT PREVIEW TITLE -->
          <p class="product-preview-title"><a href="marketplace-product.php">Gaming Coin Badges Pack</a></p>
          <!-- /PRODUCT PREVIEW TITLE -->
        ...
        <div class="product-preview-meta">
          ...
          <div class="product-preview-author">
            ...
            <!-- PRODUCT PREVIEW AUTHOR TEXT -->
            <p class="product-preview-author-text"><a href="profile-timeline.php">Nick Grissom</a></p>
            <!-- /PRODUCT PREVIEW AUTHOR TEXT -->
          </div>
          <!-- /PRODUCT PREVIEW AUTHOR -->
      ...
      <div class="product-preview">
        ...
        <div class="product-preview-info">
          ...
          <!-- PRODUCT PREVIEW TITLE -->
          <p class="product-preview-title"><a href="marketplace-product.php">Crazy Bunny Coffee Mug</a></p>
          <!-- /PRODUCT PREVIEW TITLE -->
    
          <!-- PRODUCT PREVIEW CATEGORY -->
          <p class="product-preview-category physical"><a href="marketplace-category.php">Crafts</a></p>
          <!-- /PRODUCT PREVIEW CATEGORY -->
