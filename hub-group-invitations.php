          ...
          <div class="sidebar-menu round-borders">
            ...
            <div class="sidebar-menu-item">
              ...
              <div class="sidebar-menu-body accordion-content-linked accordion-open">
                ...
                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link active" href="hub-group-invitations.php">Invitations</a>
                <!-- /SIDEBAR MENU LINK -->
              </div>
              <!-- /SIDEBAR MENU BODY -->
            </div>
          ...
          <div class="user-preview small">
            ...
            <div class="user-preview-footer padded">
              ...
              <div class="user-preview-author">
                ...
                <a class="user-preview-author-image user-avatar micro no-border" href="profile-timeline.php">
                  <!-- USER AVATAR CONTENT -->
                  <div class="user-avatar-content">
                    <!-- HEXAGON -->
                ...
                <p class="user-preview-author-text"><a href="profile-timeline.php">Neko Bebop</a></p>
                <!-- /USER PREVIEW AUTHOR TEXT -->
              </div>
              <!-- /USER PREVIEW AUTHOR -->
            </div>
