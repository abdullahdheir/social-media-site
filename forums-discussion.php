    ...
    <div class="section-filters-bar v7">
      ...
      <div class="section-filters-bar-actions">
        ...
        <div class="section-filters-bar-info">
          ...
          <p class="section-filters-bar-title"><a href="forums.php">Forums</a><span class="separator"></span><a href="forums-category.php">Animation Watchtower</a><span class="separator"></span><a href="forums-category.php">Comics</a><span class="separator"></span><a href="forums-discussion.php">Let's discuss the current state of the Comics Cinematic Universe</a></p>
          <!-- /SECTION FILTERS BAR TITLE -->
          ...
          <div class="section-filters-bar-text small-space">
            ...
            <!-- /USER AVATAR -->
            <a class="bold" href="profile-timeline.php">Neko Bebop</a>
          ...
          <div class="forum-post">
            ...
            <div class="forum-post-content">
              ...
              <div class="forum-post-user">
                <!-- USER AVATAR -->
                <a class="user-avatar no-outline" href="profile-timeline.php">
                  <!-- USER AVATAR CONTENT -->
                  <div class="user-avatar-content">
                    <!-- HEXAGON -->
                ...
                <p class="forum-post-user-title"><a href="profile-timeline.php">Sarah Diamond</a></p>
                <!-- /FORUM POST USER TITLE -->
        
                <!-- FORUM POST USER TITLE -->
                <p class="forum-post-user-text"><a href="profile-timeline.php">@sarahdiamond</a></p>
                <!-- /FORUM POST USER TITLE -->
          ...
          <div class="forum-post">
            ...
            <div class="forum-post-content">
              ...
              <div class="forum-post-user">
                ...
                <!-- FORUM POST USER TITLE -->
                <p class="forum-post-user-title"><a href="profile-timeline.php">Destroy Dex</a></p>
                <!-- /FORUM POST USER TITLE -->
        
                <!-- FORUM POST USER TITLE -->
                <p class="forum-post-user-text"><a href="profile-timeline.php">@destroydex</a></p>
                <!-- /FORUM POST USER TITLE -->
          ...
          <div class="forum-post">
            ...
            <div class="forum-post-content">
              ...
              <div class="forum-post-user">
                ...
                <!-- FORUM POST USER TITLE -->
                <p class="forum-post-user-title"><a href="profile-timeline.php">Nick Grissom</a></p>
                <!-- /FORUM POST USER TITLE -->
      
                <!-- FORUM POST USER TITLE -->
                <p class="forum-post-user-text"><a href="profile-timeline.php">@nickgrissom</a></p>
                <!-- /FORUM POST USER TITLE -->
          ...
          <div class="forum-post">
            ...
            <div class="forum-post-content">
              ...
              <div class="forum-post-user">
                ...
                <!-- FORUM POST USER TITLE -->
                <p class="forum-post-user-title"><a href="profile-timeline.php">Neko Bebop</a></p>
                <!-- /FORUM POST USER TITLE -->
      
                <!-- FORUM POST USER TITLE -->
                <p class="forum-post-user-text"><a href="profile-timeline.php">@nekobebop</a></p>
                <!-- /FORUM POST USER TITLE -->
          ...
          <div class="forum-post">
            ...
            <div class="forum-post-content">
              ...
              <div class="forum-post-user">
                ...
                <!-- FORUM POST USER TITLE -->
                <p class="forum-post-user-title"><a href="profile-timeline.php">Bearded Wonder</a></p>
                <!-- /FORUM POST USER TITLE -->
      
                <!-- FORUM POST USER TITLE -->
                <p class="forum-post-user-text"><a href="profile-timeline.php">@beardedwonder</a></p>
                <!-- /FORUM POST USER TITLE -->
