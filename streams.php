  ...
  <div class="content-grid">
      ...
      <div class="sections-slider-item">
        ...
        <div class="streamer-box small">
          ...
          <div class="streamer-box-info">
            ...
            <!-- BUTTON -->
            <a class="button small white" href="profile-timeline.php">View Profile</a>
            <!-- /BUTTON -->
    ...
    <div class="grid grid-3-3-3-3 centered">
      ...
      <div class="stream-box">
        ...
        <div class="stream-box-info">
          <!-- STREAM BOX TITLE -->
          <p class="stream-box-title"><a href="profile-stream.php">Ram Goddess Gameplay</a></p>
          <!-- /STREAM BOX TITLE -->
      ...
      <div class="stream-box">
        ...
        <div class="stream-box-info">
          <!-- STREAM BOX TITLE -->
          <p class="stream-box-title"><a href="profile-stream.php">I Play the Witch Hunters Story with...</a></p>
          <!-- /STREAM BOX TITLE -->
      ...
      <div class="stream-box">
        ...
        <div class="stream-box-info">
          <!-- STREAM BOX TITLE -->
          <p class="stream-box-title"><a href="profile-stream.php">First Play: Zodiac Goddess</a></p>
          <!-- /STREAM BOX TITLE -->
      ...
      <div class="stream-box">
        ...
        <div class="stream-box-info">
          <!-- STREAM BOX TITLE -->
          <p class="stream-box-title"><a href="profile-stream.php">Rony's EggRing Quest</a></p>
          <!-- /STREAM BOX TITLE -->
      ...
      <div class="stream-box">
        ...
        <div class="stream-box-info">
          <!-- STREAM BOX TITLE -->
          <p class="stream-box-title"><a href="profile-stream.php">Robo Bross Level Maker</a></p>
          <!-- /STREAM BOX TITLE -->
      ...
      <div class="stream-box">
        ...
        <div class="stream-box-info">
          <!-- STREAM BOX TITLE -->
          <p class="stream-box-title"><a href="profile-stream.php">Athena Goddess Gameplay</a></p>
          <!-- /STREAM BOX TITLE -->
      ...
      <div class="stream-box">
        ...
        <div class="stream-box-info">
          <!-- STREAM BOX TITLE -->
          <p class="stream-box-title"><a href="profile-stream.php">2 New Levels on Mochi's Island for the...</a></p>
          <!-- /STREAM BOX TITLE -->
      ...
      <div class="stream-box">
        ...
        <div class="stream-box-info">
          <!-- STREAM BOX TITLE -->
          <p class="stream-box-title"><a href="profile-stream.php">Hare Goddess Gameplay</a></p>
          <!-- /STREAM BOX TITLE -->
      ...
      <div class="stream-box">
        ...
        <div class="stream-box-info">
          <!-- STREAM BOX TITLE -->
          <p class="stream-box-title"><a href="profile-stream.php">1 Hour of Capture the Flag</a></p>
          <!-- /STREAM BOX TITLE -->
      ...
      <div class="stream-box">
        ...
        <div class="stream-box-info">
          <!-- STREAM BOX TITLE -->
          <p class="stream-box-title"><a href="profile-stream.php">Witch Paragliding Minigame</a></p>
          <!-- /STREAM BOX TITLE -->
      ...
      <div class="stream-box">
        ...
        <div class="stream-box-info">
          <!-- STREAM BOX TITLE -->
          <p class="stream-box-title"><a href="profile-stream.php">Exploring The Orc Witch Cave</a></p>
          <!-- /STREAM BOX TITLE -->
