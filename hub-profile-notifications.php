          ...
          <div class="sidebar-menu round-borders">
            ...
            <div class="sidebar-menu-item">
              ...
              <div class="sidebar-menu-body accordion-content-linked accordion-open">
                ...
                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link active" href="hub-profile-notifications.php">Notifications</a>
                <!-- /SIDEBAR MENU LINK -->
            ...
            <div class="sidebar-menu-item">
              ...
              <div class="sidebar-menu-body accordion-content-linked">
                ...
                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link" href="hub-store-items.php">Manage Items</a>
                <!-- /SIDEBAR MENU LINK -->
        ...
        <div class="notification-box-list">
          ...
          <div class="notification-box unread">
            ...
            <div class="user-status notification">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title"><a class="bold" href="profile-timeline.php">Neko Bebop</a> replied to a comment you made on your <a class="highlighted" href="profile-timeline.php">status update</a></p>
              <!-- /USER STATUS TITLE -->
          ...
          <div class="notification-box">
            ...
            <div class="user-status notification">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title"><a class="bold" href="profile-timeline.php">Rosie Sakura</a> shared your <a class="highlighted" href="profile-timeline.php">status update</a></p>
              <!-- /USER STATUS TITLE -->
          ...
          <div class="notification-box">
            ...
            <div class="user-status notification">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title"><a class="bold" href="profile-timeline.php">Bearded Wonder</a> left a happy <img class="reaction" src="img/reaction/happy.png" alt="reaction-happy"> reaction on your <a class="highlighted" href="profile-timeline.php">status update</a></p>
              <!-- /USER STATUS TITLE -->
