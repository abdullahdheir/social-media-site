          ...
          <div class="sidebar-menu round-borders">
            ...
            <div class="sidebar-menu-item">
              ...
              <div class="sidebar-menu-body accordion-content-linked">
                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link" href="hub-profile-info.php">Profile Info</a>
                <!-- /SIDEBAR MENU LINK -->

                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link" href="hub-profile-social.php">Social &amp; Stream</a>
                <!-- /SIDEBAR MENU LINK -->

                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link" href="hub-profile-notifications.php">Notifications</a>
                <!-- /SIDEBAR MENU LINK -->

                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link" href="hub-profile-messages.php">Messages</a>
                <!-- /SIDEBAR MENU LINK -->

                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link" href="hub-profile-requests.php">Friend Requests</a>
                <!-- /SIDEBAR MENU LINK -->
              </div>
              <!-- /SIDEBAR MENU BODY -->
            </div>
            ...
            <div class="sidebar-menu-item">
              ...
              <div class="sidebar-menu-body accordion-content-linked">
                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link" href="hub-account-info.php">Account Info</a>
                <!-- /SIDEBAR MENU LINK -->

                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link" href="hub-account-password.php">Change Password</a>
                <!-- /SIDEBAR MENU LINK -->

                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link" href="hub-account-settings.php">General Settings</a>
                <!-- /SIDEBAR MENU LINK -->
              </div>
              <!-- /SIDEBAR MENU BODY -->
            </div>
            ...
            <div class="sidebar-menu-item">
              ...
              <div class="sidebar-menu-body accordion-content-linked">
                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link" href="hub-group-management.php">Manage Groups</a>
                <!-- /SIDEBAR MENU LINK -->

                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link" href="hub-group-invitations.php">Invitations</a>
                <!-- /SIDEBAR MENU LINK -->
              </div>
              <!-- /SIDEBAR MENU BODY -->
            </div>
            ...
            <div class="sidebar-menu-item">
              ...
              <div class="sidebar-menu-body accordion-content-linked accordion-open">
                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link" href="hub-store-account.php">My Account</a>
                <!-- /SIDEBAR MENU LINK -->

                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link" href="hub-store-statement.php">Sales Statement</a>
                <!-- /SIDEBAR MENU LINK -->

                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link active" href="hub-store-items.php">Manage Items</a>
                <!-- /SIDEBAR MENU LINK -->

                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link" href="hub-store-downloads.php">Downloads</a>
                <!-- /SIDEBAR MENU LINK -->
              </div>
              <!-- /SIDEBAR MENU BODY -->
            </div>
        ...
        <div class="grid grid-3-3-3 centered-on-mobile">
          ...
          <div class="product-preview fixed-height">
            ...
            <div class="product-preview-info">
              ...
              <!-- PRODUCT PREVIEW TITLE -->
              <p class="product-preview-title"><a href="marketplace-product.php">American Football Team Page</a></p>
              <!-- /PRODUCT PREVIEW TITLE -->
          ...
          <div class="product-preview fixed-height">
            ...
            <div class="product-preview-info">
              ...
              <!-- PRODUCT PREVIEW TITLE -->
              <p class="product-preview-title"><a href="marketplace-product.php">Asgard Social Media Builder for...</a></p>
              <!-- /PRODUCT PREVIEW TITLE -->
        
              <!-- PRODUCT PREVIEW CATEGORY -->
              <p class="product-preview-category digital"><a href="marketplace-category.php">WP Templates</a></p>
              <!-- /PRODUCT PREVIEW CATEGORY -->
          ...
          <div class="product-preview fixed-height">
            ...
            <div class="product-preview-info">
              ...
              <!-- PRODUCT PREVIEW TITLE -->
              <p class="product-preview-title"><a href="marketplace-product.php">Login and Register Forms</a></p>
              <!-- /PRODUCT PREVIEW TITLE -->
