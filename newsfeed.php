  ...
  <div class="grid grid-3-6-3 mobile-prefer-content">
    ...
    <div class="grid-column">
      ...
      <div class="widget-box">
        ...
        <!-- WIDGET BOX BUTTON -->
        <a class="widget-box-button button small white" href="quests.php">See all Quests!</a>
        <!-- /WIDGET BOX BUTTON -->
      </div>
      <!-- /WIDGET BOX -->
    </div>
        ...
        <div class="widget-box-status">
          ...
          <div class="widget-box-status-content">
            ...
            <div class="user-status">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title medium"><a class="bold" href="profile-timeline.php">Neko Bebop</a> uploaded a <span class="bold">video</span></p>
              <!-- /USER STATUS TITLE -->
          ...
          <div class="widget-box-status-content">
            ...
            <div class="tag-list">
              ...
              <!-- TAG ITEM -->
              <a class="tag-item secondary" href="newsfeed.php">StrikerGO</a>
              <!-- /TAG ITEM -->

              <!-- TAG ITEM -->
              <a class="tag-item secondary" href="newsfeed.php">Outlaws</a>
              <!-- /TAG ITEM -->
        ...
        <div class="widget-box-status">
          ...
          <div class="widget-box-status-content">
            ...
            <div class="user-status">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title medium"><a class="bold" href="profile-timeline.php">Sarah Diamond</a> created a <span class="bold">poll</span></p>
              <!-- /USER STATUS TITLE -->
        ...
        <div class="widget-box-status">
          ...
          <div class="widget-box-status-content">
            ...
            <div class="user-status">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title medium"><a class="bold" href="profile-timeline.php">Destroy Dex</a> uploaded <span class="bold">26 new photos</span></p>
              <!-- /USER STATUS TITLE -->
            ...
            <div class="picture-collage">
              ...
              <div class="picture-collage-row">
                ...
                <div class="picture-collage-item">
                  ...
                  <a class="picture-collage-item-overlay" href="profile-photos.php">
            ...
            <div class="tag-list">
              ...
              <!-- TAG ITEM -->
              <a class="tag-item secondary" href="newsfeed.php">StreamCon</a>
              <!-- /TAG ITEM -->

              <!-- TAG ITEM -->
              <a class="tag-item secondary" href="newsfeed.php">StarGirl</a>
              <!-- /TAG ITEM -->
            </div>
            <!-- /TAG LIST -->
        ...
        <div class="widget-box-status">
          ...
          <div class="widget-box-status-content">
            ...
            <div class="user-status">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title medium"><a class="bold" href="profile-timeline.php">Nick Grissom</a> shared a <span class="bold">post</span></p>
              <!-- /USER STATUS TITLE -->
              ...
              <div class="widget-box-status">
                ...
                <div class="widget-box-status-content">
                  ...
                  <div class="user-status">
                    ...
                    <!-- USER STATUS TITLE -->
                    <p class="user-status-title medium"><a class="bold" href="profile-timeline.php">Destroy Dex</a></p>
                    <!-- /USER STATUS TITLE -->
        ...
        <div class="widget-box-status">
          ...
          <div class="widget-box-status-content">
            ...
            <div class="user-status">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title medium"><a class="bold" href="profile-timeline.php">Nick Grissom</a></p>
              <!-- /USER STATUS TITLE -->
        ...
        <div class="widget-box-content">
          ...
          <div class="user-status-list">
            ...
            <div class="user-status">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title"><a class="bold" href="profile-timeline.php">Neko Bebop</a> commented on Destroy Dex's <a class="highlighted" href="profile-timeline.php">photo</a></p>
              <!-- /USER STATUS TITLE -->
            ...
            <div class="user-status">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title"><a class="bold" href="profile-timeline.php">Nick Grissom</a> liked Marina Valentine's <a class="highlighted" href="profile-timeline.php">status update</a></p>
              <!-- /USER STATUS TITLE -->
            ...
            <div class="user-status">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title"><a class="bold" href="profile-timeline.php">The Green Goo</a> liked Nick Grissom's <a class="highlighted" href="profile-timeline.php">video</a></p>
              <!-- /USER STATUS TITLE -->
            ...
            <div class="user-status">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title"><a class="bold" href="profile-timeline.php">Nick Grissom</a> changed his <a class="highlighted" href="profile-timeline.php">profile picture</a></p>
              <!-- /USER STATUS TITLE -->
            ...
            <div class="user-status">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title"><a class="bold" href="profile-timeline.php">Destroy Dex</a> commented on Rosie Sakura's <a class="highlighted" href="profile-timeline.php">profile</a></p>
              <!-- /USER STATUS TITLE -->
