  ...
  <div class="content-grid">
    ...
    <div class="section-header">
      ...
      <div class="section-header-actions">
        ...
        <!-- SECTION HEADER SUBSECTION -->
        <a class="section-header-subsection" href="marketplace-category.php">Digital Items</a>
        <!-- /SECTION HEADER SUBSECTION -->
            ...
            <div class="tab-box-item">
              ...
              <div class="post-comment-list no-border-top">
                ...
                <div class="post-comment">
                  ...
                  <!-- POST COMMENT TEXT -->
                  <p class="post-comment-text user-tag purchased"><a class="post-comment-text-author" href="profile-timeline.php">Bearded Wonder</a></p>
                  <!-- /POST COMMENT TEXT -->
                ...
                <div class="post-comment unread reply-2">
                  ...
                  <!-- POST COMMENT TEXT -->
                  <p class="post-comment-text user-tag author"><a class="post-comment-text-author" href="profile-timeline.php">Marina Valentine</a></p>
                  <!-- /POST COMMENT TEXT -->
                ...
                <div class="post-comment">
                  ...
                  <!-- POST COMMENT TEXT -->
                  <p class="post-comment-text"><a class="post-comment-text-author" href="profile-timeline.php">Nick Grissom</a></p>
                  <!-- /POST COMMENT TEXT -->
                ...
                <div class="post-comment">
                  ...
                  <!-- POST COMMENT TEXT -->
                  <p class="post-comment-text user-tag purchased"><a class="post-comment-text-author" href="profile-timeline.php">Neko Bebop</a></p>
                  <!-- /POST COMMENT TEXT -->
                ...
                <div class="post-comment">
                  ...
                  <div class="content-actions">
                    ...
                    <div class="content-action">
                      ...
                      <div class="meta-line">
                        <!-- META LINE TEXT -->
                        <p class="meta-line-text"><a href="profile-timeline.php">Nick Grissom</a></p>
                        <!-- /META LINE TEXT -->
                      </div>
                      <!-- /META LINE -->
                ...
                <div class="post-comment">
                  ...
                  <div class="content-actions">
                    ...
                    <div class="content-action">
                      ...
                      <div class="meta-line">
                        <!-- META LINE TEXT -->
                        <p class="meta-line-text"><a href="profile-timeline.php">Bearded Wonder</a></p>
                        <!-- /META LINE TEXT -->
                      </div>
                      <!-- /META LINE -->
                ...
                <div class="post-comment">
                  ...
                  <div class="content-actions">
                    ...
                    <div class="content-action">
                      ...
                      <div class="meta-line">
                        <!-- META LINE TEXT -->
                        <p class="meta-line-text"><a href="profile-timeline.php">Sarah Diamond</a></p>
                        <!-- /META LINE TEXT -->
                      </div>
                      <!-- /META LINE -->
      ...
      <div class="marketplace-sidebar">
        ...
        <div class="sidebar-box">
          ...
          <div class="sidebar-box-items">
            ...
            <!-- BUTTON -->
            <a class="button small white" href="profile-store.php">View Author's Store</a>
            <!-- /BUTTON -->
          </div>
          <!-- /SIDEBAR BOX ITEMS -->
          ...
          <div class="sidebar-box-items">
            ...
            <div class="information-line-list">
              ...
              <div class="information-line">
                ...
                <!-- INFORMATION LINE TEXT -->
                <p class="information-line-text"><a href="marketplace-category.php">HTML Templates</a></p>
                <!-- /INFORMATION LINE TEXT -->
              </div>
              <!-- /INFORMATION LINE -->
              ...
              <div class="information-line">
                ...
                <!-- INFORMATION LINE TEXT -->
                <p class="information-line-text"><span class="bold"><a href="marketplace-category.php">Gaming</a>, <a href="marketplace-category.php">Magazine</a>, <a href="marketplace-category.php">Web</a>, <a href="marketplace-category.php">eSports</a>, <a href="marketplace-category.php">Template</a></span></p>
                <!-- /INFORMATION LINE TEXT -->
              </div>
              <!-- /INFORMATION LINE -->
            </div>
