      ...
      <div class="calendar-widget-header">
        ...
        <div class="calendar-widget-header-actions">
          ...
          <div class="view-actions">
            ...
            <!-- VIEW ACTION -->
            <a class="view-action text-tooltip-tft-medium active" href="events-weekly.php" data-title="Weekly">
              <!-- VIEW ACTION ICON -->
            ...
            <!-- VIEW ACTION -->
            <a class="view-action text-tooltip-tft-medium" href="events-daily.php" data-title="Daily">
              <!-- VIEW ACTION ICON -->
