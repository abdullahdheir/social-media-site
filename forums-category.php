    ...
    <div class="section-filters-bar v7">
      ...
      <div class="section-filters-bar-actions">
        ...
        <div class="section-filters-bar-info">
          ...
          <p class="section-filters-bar-title"><a href="forums.php">Forums</a><span class="separator"></span><a href="forums-category.php">Animation Watchtower</a></p>
          <!-- /SECTION FILTERS BAR TITLE -->
          ...
          <div class="section-filters-bar-text small-space">
            Last post by
            <!-- USER AVATAR -->
            <a class="user-avatar micro no-stats" href="profile-timeline.php">
              <!-- USER AVATAR BORDER -->
              <div class="user-avatar-border">
                <!-- HEXAGON -->
                <div class="hexagon-22-24"></div>
            ...
            <!-- /USER AVATAR -->
            <a class="bold" href="profile-timeline.php">Nick Grissom</a>
            2 minutes ago
          </div>
          <!-- /SECTION FILTERS BAR TEXT -->
        </div>
      ...
      <div class="table-body">
        ...
        <div class="table-row big">
          ...
          <div class="table-column">
            ...
            <div class="forum-category">
              ...
              <div class="forum-category-info">
                ...
                <p class="forum-category-title"><a href="forums-category.php">Comics</a></p>
                <!-- /FORUM CATEGORY TITLE -->
          ...
          <div class="table-column padded-big-left">
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">Bebop Publishing will release a limited edition of "Justice"</a>
            <!-- /TABLE LINK -->
  
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">This is the first image of the new "Multiverse" movie!</a>
            <!-- /TABLE LINK -->
  
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">What actor do you think should play the new Captain?</a>
            <!-- /TABLE LINK -->
          </div>
          <!-- /TABLE COLUMN -->
        </div>
        ...
        <div class="table-row big">
          ...
          <div class="table-column">
            ...
            <div class="forum-category">
              ...
              <div class="forum-category-info">
                <!-- FORUM CATEGORY TITLE -->
                <p class="forum-category-title"><a href="forums-category.php">Anime &amp; Manga</a></p>
                <!-- /FORUM CATEGORY TITLE -->
          ...
          <div class="table-column padded-big-left">
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">Come and discuss that new "Power X" transformation</a>
            <!-- /TABLE LINK -->
  
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">Hunter's manga chapter 526 will release in December</a>
            <!-- /TABLE LINK -->
  
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">A new animation studio will take over after this month</a>
            <!-- /TABLE LINK -->
          </div>
          <!-- /TABLE COLUMN -->
        </div>
      ...
      <div class="table-body">
        ...
        <div class="table-row mid">
          ...
          <div class="table-column">
            ...
            <div class="discussion-preview pinned">
              ...
              <a class="discussion-preview-title" href="forums-discussion.php">Let's discuss the current state of the Comics Cinematic Universe</a>
              <!-- /DISCUSSION PREVIEW TITLE -->
  
              <!-- PAGE ITEMS -->
              <div class="page-items">
                <!-- PAGE ITEM -->
                <a class="page-item" href="forums-discussion.php">01</a>
                <!-- /PAGE ITEM -->
  
                <!-- PAGE ITEM -->
                <a class="page-item" href="forums-discussion.php">02</a>
                <!-- /PAGE ITEM -->
  
                <!-- PAGE ITEM -->
                <a class="page-item" href="forums-discussion.php">03</a>
                <!-- /PAGE ITEM -->
                ...
                <!-- PAGE ITEM -->
                <a class="page-item" href="forums-discussion.php">44</a>
                <!-- /PAGE ITEM -->
  
                <!-- PAGE ITEM -->
                <a class="page-item" href="forums-discussion.php">45</a>
                <!-- /PAGE ITEM -->
  
                <!-- PAGE ITEM -->
                <a class="page-item" href="forums-discussion.php">46</a>
                <!-- /PAGE ITEM -->
              </div>
              <!-- /PAGE ITEMS -->
              ...
              <div class="discussion-preview-meta">
                ...
                <!-- DISCUSSION PREVIEW META TEXT -->
                <p class="discussion-preview-meta-text"><a href="profile-timeline.php">Sarah Diamond</a> 2 months ago</p>
                <!-- /DISCUSSION PREVIEW META TEXT -->
              </div>
              <!-- /DISCUSSION PREVIEW META -->
            </div>
        ...
        <div class="table-row medium">
          ...
          <div class="table-column">
            ...
            <div class="discussion-preview">
              <!-- DISCUSSION PREVIEW TITLE -->
              <a class="discussion-preview-title" href="forums-discussion.php">Bebop Publishing will release a limited edition of "Justice"</a>
              <!-- /DISCUSSION PREVIEW TITLE -->
              ...
              <div class="discussion-preview-meta">
                ...
                <!-- DISCUSSION PREVIEW META TEXT -->
                <p class="discussion-preview-meta-text"><a href="profile-timeline.php">Bearded Wonder</a> 5 hours ago</p>
                <!-- /DISCUSSION PREVIEW META TEXT -->
              </div>
              <!-- /DISCUSSION PREVIEW META -->
            </div>
        ...
        <div class="table-row medium">
          ...
          <div class="table-column">
            ...
            <div class="discussion-preview">
              <!-- DISCUSSION PREVIEW TITLE -->
              <a class="discussion-preview-title" href="forums-discussion.php">Come and discuss that new "Power X" transformation</a>
              <!-- /DISCUSSION PREVIEW TITLE -->
              ...
              <div class="discussion-preview-meta">
                ...
                <!-- DISCUSSION PREVIEW META TEXT -->
                <p class="discussion-preview-meta-text"><a href="profile-timeline.php">Crimson Thunder</a> 1 hour ago</p>
                <!-- /DISCUSSION PREVIEW META TEXT -->
              </div>
              <!-- /DISCUSSION PREVIEW META -->
            </div>
        ...
        <div class="table-row medium">
          ...
          <div class="table-column">
            ...
            <div class="discussion-preview">
              <!-- DISCUSSION PREVIEW TITLE -->
              <a class="discussion-preview-title" href="forums-discussion.php">This is the first image of the new "Multiverse" movie!</a>
              <!-- /DISCUSSION PREVIEW TITLE -->
              ...
              <div class="discussion-preview-meta">
                ...
                <!-- DISCUSSION PREVIEW META TEXT -->
                <p class="discussion-preview-meta-text"><a href="profile-timeline.php">Nick Grissom</a> 14 hours ago</p>
                <!-- /DISCUSSION PREVIEW META TEXT -->
              </div>
              <!-- /DISCUSSION PREVIEW META -->
            </div>
        ...
        <div class="table-row medium">
          ...
          <div class="table-column">
            ...
            <div class="discussion-preview">
              <!-- DISCUSSION PREVIEW TITLE -->
              <a class="discussion-preview-title" href="forums-discussion.php">What actor do you think should play the new Captain?</a>
              <!-- /DISCUSSION PREVIEW TITLE -->
              ...
              <div class="discussion-preview-meta">
                ...
                <!-- DISCUSSION PREVIEW META TEXT -->
                <p class="discussion-preview-meta-text"><a href="profile-timeline.php">Neko Bebop</a> 6 days ago</p>
                <!-- /DISCUSSION PREVIEW META TEXT -->
              </div>
              <!-- /DISCUSSION PREVIEW META -->
            </div>
        ...
        <div class="table-row medium">
          ...
          <div class="table-column">
            ...
            <div class="discussion-preview">
              <!-- DISCUSSION PREVIEW TITLE -->
              <a class="discussion-preview-title" href="forums-discussion.php">Hunter's manga chapter 526 will release in December</a>
              <!-- /DISCUSSION PREVIEW TITLE -->
              ...
              <div class="discussion-preview-meta">
                ...
                <!-- DISCUSSION PREVIEW META TEXT -->
                <p class="discussion-preview-meta-text"><a href="profile-timeline.php">Damian Greyson</a> 2 weeks ago</p>
                <!-- /DISCUSSION PREVIEW META TEXT -->
              </div>
              <!-- /DISCUSSION PREVIEW META -->
            </div>
        ...
        <div class="table-row medium">
          ...
          <div class="table-column">
            ...
            <div class="discussion-preview">
              <!-- DISCUSSION PREVIEW TITLE -->
              <a class="discussion-preview-title" href="forums-discussion.php">A new animation studio will take over after this month</a>
              <!-- /DISCUSSION PREVIEW TITLE -->
              ...
              <div class="discussion-preview-meta">
                ...
                <!-- DISCUSSION PREVIEW META TEXT -->
                <p class="discussion-preview-meta-text"><a href="profile-timeline.php">Bearded Wonder</a> 2 weeks ago</p>
                <!-- /DISCUSSION PREVIEW META TEXT -->
              </div>
              <!-- /DISCUSSION PREVIEW META -->
            </div>
        ...
        <div class="table-row medium">
          ...
          <div class="table-column">
            ...
            <div class="discussion-preview">
              <!-- DISCUSSION PREVIEW TITLE -->
              <a class="discussion-preview-title" href="forums-discussion.php">Season 4 of "Fireman" is officially confirmed by the creators!</a>
              <!-- /DISCUSSION PREVIEW TITLE -->
              ...
              <div class="discussion-preview-meta">
                ...
                <!-- DISCUSSION PREVIEW META TEXT -->
                <p class="discussion-preview-meta-text"><a href="profile-timeline.php">The Green Goo</a> 5 months ago</p>
                <!-- /DISCUSSION PREVIEW META TEXT -->
              </div>
              <!-- /DISCUSSION PREVIEW META -->
            </div>
