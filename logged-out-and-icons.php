...
<body>
  ...
  <header class="header logged-out">
    ...
    <div class="header-actions">
      ...
      <!-- REGISTER BUTTON -->
      <a class="register-button button no-shadow" href="index.php">Register</a>
      <!-- /REGISTER BUTTON -->
  ...
  <aside class="floaty-bar logged-out">
    <!-- LOGIN BUTTON -->
    <a class="login-button button small primary" href="index.php">Login &amp; Register</a>
    <!-- /LOGIN BUTTON -->
  </aside>
  <!-- /FLOATY BAR -->
  ...
  <div class="content-grid">
    ...
    <div class="section-header">
      ...
      <div class="section-header-actions">
        ...
        <a class="section-header-action" href="profile-timeline.php">Go Back</a>
        <!-- /SECTION HEADER ACTION -->
      </div>
      <!-- /SECTION HEADER ACTIONS -->
    </div>
