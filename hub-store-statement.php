          ...
          <div class="sidebar-menu round-borders">
            ...
            <div class="sidebar-menu-item">
              ...
              <div class="sidebar-menu-body accordion-content-linked accordion-open">
                ...
                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link active" href="hub-store-statement.php">Sales Statement</a>
                <!-- /SIDEBAR MENU LINK -->
            ...
            <div class="table-body same-color-rows">
              ...
              <div class="table-row micro">
                ...
                <div class="table-column padded-left">
                  <!-- TABLE LINK -->
                  <a class="table-link" href="marketplace-product.php"><span class="highlighted">Pixel Diamond Gaming Magazine</span></a>
                  <!-- /TABLE LINK -->
                </div>
                <!-- /TABLE COLUMN -->
              ...
              <div class="table-row micro">
                ...
                <div class="table-column padded-left">
                  <!-- TABLE LINK -->
                  <a class="table-link" href="marketplace-product.php"><span class="highlighted">Twitch Stream UI Pack</span></a>
                  <!-- /TABLE LINK -->
                </div>
                <!-- /TABLE COLUMN -->
              ...
              <div class="table-row micro">
                ...
                <div class="table-column padded-left">
                  <!-- TABLE LINK -->
                  <a class="table-link" href="marketplace-product.php"><span class="highlighted">Gaming Coin Badges Pack</span></a>
                  <!-- /TABLE LINK -->
                </div>
                <!-- /TABLE COLUMN -->
              ...
              <div class="table-row micro">
                ...
                <div class="table-column padded-left">
                  <!-- TABLE LINK -->
                  <a class="table-link" href="marketplace-product.php"><span class="highlighted">People Illustrations Pack 01</span></a>
                  <!-- /TABLE LINK -->
                </div>
                <!-- /TABLE COLUMN -->
              ...
              <div class="table-row micro">
                ...
                <div class="table-column padded-left">
                  <!-- TABLE LINK -->
                  <a class="table-link" href="marketplace-product.php"><span class="highlighted">Emerald Dragon Digital Marketplace</span></a>
                  <!-- /TABLE LINK -->
                </div>
                <!-- /TABLE COLUMN -->
