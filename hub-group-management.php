          ...
          <div class="sidebar-menu round-borders">
            ...
            <div class="sidebar-menu-item">
              ...
              <div class="sidebar-menu-body accordion-content-linked accordion-open">
                <!-- SIDEBAR MENU LINK -->
                <a class="sidebar-menu-link active" href="hub-group-management.php">Manage Groups</a>
                <!-- /SIDEBAR MENU LINK -->
          ...
          <div class="user-preview small fixed-height-medium">
            ...
            <div class="user-preview-info">
              ...
              <div class="user-short-description small">
                ...
                <!-- USER SHORT DESCRIPTION TITLE -->
                <p class="user-short-description-title small"><a href="group-timeline.php">Cosplayers of the World</a></p>
                <!-- /USER SHORT DESCRIPTION TITLE -->
