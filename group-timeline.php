  ...
  <div class="content-grid">
    ...
    <div class="profile-header v2">
      ...
      <div class="profile-header-info">
        ...
        <div class="user-short-description big">
          <!-- USER SHORT DESCRIPTION AVATAR -->
          <a class="user-short-description-avatar user-avatar big no-stats" href="group-timeline.php">
            <!-- USER AVATAR BORDER -->
            <div class="user-avatar-border">
              <!-- HEXAGON -->
          ...
          <!-- USER SHORT DESCRIPTION AVATAR -->
          <a class="user-short-description-avatar user-short-description-avatar-mobile user-avatar medium no-stats" href="group-timeline.php">
            <!-- USER AVATAR BORDER -->
            <div class="user-avatar-border">
              <!-- HEXAGON -->
          ...
          <!-- USER SHORT DESCRIPTION TITLE -->
          <p class="user-short-description-title"><a href="group-timeline.php">Cosplayers of the World</a></p>
          <!-- /USER SHORT DESCRIPTION TITLE -->
        ...
        <div class="profile-header-info-actions">
          ...
          <!-- PROFILE HEADER INFO ACTION -->
          <a class="profile-header-info-action button" href="hub-group-management.php">
            <!-- ICON MORE DOTS -->
    ...
    <nav class="section-navigation">
      ...
      <div id="section-navigation-medium-slider" class="section-menu secondary">
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item active" href="group-timeline.php">
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="group-info.php">
          <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="group-members.php">
          <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="group-events.php">
          <!-- SECTION MENU ITEM ICON -->
          ...
          <div class="widget-box-content">
            ...
            <div class="user-status-list">
              ...
              <div class="user-status request-small">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Rosie Sakura</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status request-small">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Peter Stark</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="user-status request-small">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Bearded Wonder</a></p>
                <!-- /USER STATUS TITLE -->
          ...
          <div class="widget-box-status">
            ...
            <div class="widget-box-status-content">
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title medium"><a class="bold" href="profile-timeline.php">Neko Bebop</a></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="tag-list">
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Discord</a>
                <!-- /TAG ITEM -->
      
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Cosplay</a>
                <!-- /TAG ITEM -->
      
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Costume</a>
                <!-- /TAG ITEM -->
      
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Channel</a>
                <!-- /TAG ITEM -->
              </div>
              <!-- /TAG LIST -->
          ...
          <div class="widget-box-status">
            ...
            <div class="widget-box-status-content">
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title medium"><a class="bold" href="profile-timeline.php">Marina Valentine</a> uploaded <span class="bold">23 new photos</span></p>
                <!-- /USER STATUS TITLE -->
              ...
              <div class="tag-list">
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Photos</a>
                <!-- /TAG ITEM -->
                ...
                <!-- TAG ITEM -->
                <a class="tag-item secondary" href="newsfeed.php">Inspiration</a>
                <!-- /TAG ITEM -->
              </div>
              <!-- /TAG LIST -->
          ...
          <div class="widget-box-status">
            ...
            <div class="widget-box-status-content">
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <div class="user-status-title medium"><a class="bold" href="profile-timeline.php">Neko Bebop</a> replied to the discussion <a class="bold" href="forums-discussion.php">In your opinion, who has the best Cosplay?</a> in the forum
                  <!-- USER AVATAR -->
                  <a class="user-avatar micro no-stats" href="group-timeline.php">
                    <!-- USER AVATAR BORDER -->
                    <div class="user-avatar-border">
                      <!-- HEXAGON -->
                      <div class="hexagon-22-24"></div>
                  ...
                  <!-- /USER AVATAR -->
                  <a class="bold" href="group-timeline.php">Cosplayers of the World</a>
                </div>
                <!-- /USER STATUS TITLE -->
          ...
          <div class="widget-box-status">
            ...
            <div class="widget-box-status-content">
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title medium"><a class="bold" href="profile-timeline.php">Nick Grissom</a> uploaded a <span class="bold">video</span></p>
                <!-- /USER STATUS TITLE -->
          ...
          <div class="widget-box-status">
            ...
            <div class="widget-box-status-content">
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title medium"><a class="bold" href="profile-timeline.php">Bearded Wonder</a></p>
                <!-- /USER STATUS TITLE -->
          ...
          <div class="widget-box-content">
            ...
            <div class="user-status-list">
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="profile-timeline.php">Marina Valentine</a></p>
                <!-- /USER STATUS TITLE -->
          ...
          <div class="widget-box-content">
            ...
            <div class="post-preview-line-list">
              ...
              <div class="post-preview-line">
                ...
                <p class="post-preview-line-title"><a href="forums-discussion.php">In your opinion, who has the best cosplay?</a></p>
                <!-- /POST PREVIEW LINE TITLE -->
            
                <!-- POST PREVIEW LINE META -->
                <div class="post-preview-line-meta">
                  <!-- USER AVATAR -->
                  <a class="user-avatar micro no-border" href="profile-timeline.php">
                    <!-- USER AVATAR CONTENT -->
                    <div class="user-avatar-content">
                      <!-- HEXAGON -->
                      <div class="hexagon-image-18-20" data-src="img/avatar/05.jpg"></div>
                  ...
                  <p class="post-preview-line-author"><a href="profile-timeline.php">By Neko Bebop</a></p>
                  <!-- /POST PREVIEW LINE AUTHOR -->
              ...
              <div class="post-preview-line">
                <!-- POST PREVIEW LINE TITLE -->
                <p class="post-preview-line-title"><a href="forums-discussion.php">Preparing everything for CosWorld 2019, show your works here!</a></p>
                <!-- /POST PREVIEW LINE TITLE -->
                ...
                <div class="post-preview-line-meta">
                  ...
                  <!-- POST PREVIEW LINE AUTHOR -->
                  <p class="post-preview-line-author"><a href="profile-timeline.php">By Nick Grissom</a></p>
                  <!-- /POST PREVIEW LINE AUTHOR -->
              ...
              <div class="post-preview-line">
                <!-- POST PREVIEW LINE TITLE -->
                <p class="post-preview-line-title"><a href="forums-discussion.php">Official Topic! Let's organize the global meetups for all continents!</a></p>
                <!-- /POST PREVIEW LINE TITLE -->
                ...
                <div class="post-preview-line-meta">
                  ...
                  <!-- POST PREVIEW LINE AUTHOR -->
                  <p class="post-preview-line-author"><a href="profile-timeline.php">By Destroy Dex</a></p>
                  <!-- /POST PREVIEW LINE AUTHOR -->
              ...
              <div class="post-preview-line">
                <!-- POST PREVIEW LINE TITLE -->
                <p class="post-preview-line-title"><a href="forums-discussion.php">Share your cosplay tips here! Tutorials, DIY's, paints and more</a></p>
                <!-- /POST PREVIEW LINE TITLE -->
              ...
              <div class="post-preview-line">
                <!-- POST PREVIEW LINE TITLE -->
                <p class="post-preview-line-title"><a href="forums-discussion.php">Check out all the pictures I took at the CosplayWonder 2018</a></p>
                <!-- /POST PREVIEW LINE TITLE -->
                ...
                <div class="post-preview-line-meta">
                  ...
                  <!-- POST PREVIEW LINE AUTHOR -->
                  <p class="post-preview-line-author"><a href="profile-timeline.php">By Sarah Diamond</a></p>
                  <!-- /POST PREVIEW LINE AUTHOR -->
  ...
  <div class="popup-event popup-event-information">
    ...
    <div class="popup-event-info">
      ...
      <div class="user-avatar-list reverse medium">
        ...
        <!-- USER AVATAR -->
        <a class="user-avatar smaller no-stats" href="group-members.php">
          <!-- USER AVATAR BORDER -->
          <div class="user-avatar-border">
            <!-- HEXAGON -->
            <div class="hexagon-34-36"></div>
    ...
    <div class="post-comment-list">
      ...
      <div class="post-comment">
        ...
        <!-- POST COMMENT TEXT -->
        <p class="post-comment-text"><a class="post-comment-text-author" href="profile-timeline.php">Destroy Dex</a>Can't wait to see everyone at the party! Last year's was incredible and I'm hoping this year will be even better!</p>
        <!-- /POST COMMENT TEXT -->
