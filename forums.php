    ...
    <div class="section-filters-bar v7">
      ...
      <div class="section-filters-bar-actions">
        ...
        <div class="section-filters-bar-info">
          ...
          <p class="section-filters-bar-title"><a href="forums.php">Forums</a></p>
          <!-- /SECTION FILTERS BAR TITLE -->
  
          <!-- SECTION FILTERS BAR TEXT -->
          <p class="section-filters-bar-text">Last category added <a class="highlighted" href="forums-category.php">The Jukebox</a> 2 weeks ago</p>
          <!-- /SECTION FILTERS BAR TEXT -->
        </div>
        <!-- /SECTION FILTERS BAR INFO -->
      </div>
      ...
      <div class="table-body">
        ...
        <div class="table-row big">
          ...
          <div class="table-column">
            ...
            <div class="forum-category">
              ...
              <div class="forum-category-info">
                ...
                <p class="forum-category-title"><a href="forums-category.php">Community Hangout</a></p>
                <!-- /FORUM CATEGORY TITLE -->
          ...
          <div class="table-column padded-big-left">
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">What's your favourite food in the world?</a>
            <!-- /TABLE LINK -->
  
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">Share a picture of your city or town and let's travel together!</a>
            <!-- /TABLE LINK -->
  
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">Do you think we'll ever get flying cars in the future?</a>
            <!-- /TABLE LINK -->
          </div>
          <!-- /TABLE COLUMN -->
        </div>
        ...
        <div class="table-row big">
          ...
          <div class="table-column">
            ...
            <div class="forum-category">
              ...
              <div class="forum-category-info">
                <!-- FORUM CATEGORY TITLE -->
                <p class="forum-category-title"><a href="forums-category.php">The Arcade</a></p>
                <!-- /FORUM CATEGORY TITLE -->
          ...
          <div class="table-column padded-big-left">
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">Post your GTE V character photo and vote for the best!</a>
            <!-- /TABLE LINK -->
  
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">Does anyone know how to capture Mewthree?</a>
            <!-- /TABLE LINK -->
  
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">Super Brawl Bross tournament. Sign up right here!</a>
            <!-- /TABLE LINK -->
          </div>
          <!-- /TABLE COLUMN -->
        </div>
        ...
        <div class="table-row big">
          ...
          <div class="table-column">
            ...
            <div class="forum-category">
              ...
              <div class="forum-category-info">
                <!-- FORUM CATEGORY TITLE -->
                <p class="forum-category-title"><a href="forums-category.php">Cosplayers of the World</a></p>
                <!-- /FORUM CATEGORY TITLE -->
          ...
          <div class="table-column padded-big-left">
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">Introduce yourself and show us your cosplays!</a>
            <!-- /TABLE LINK -->
  
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">Show your progress. Post a photo of your first and last cosplay</a>
            <!-- /TABLE LINK -->
  
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">Tips on how to build a resistant yet light armor</a>
            <!-- /TABLE LINK -->
          </div>
          <!-- /TABLE COLUMN -->
        </div>
        ...
        <div class="table-row big auto">
          ...
          <div class="table-column">
            ...
            <div class="forum-category">
              ...
              <div class="forum-category-info">
                <!-- FORUM CATEGORY TITLE -->
                <p class="forum-category-title"><a href="forums-category.php">Animation Watchtower</a></p>
                <!-- /FORUM CATEGORY TITLE -->
                ...
                <!-- FORUM CATEGORY LINK -->
                <p class="forum-category-link"><a href="forums-category.php">Comics</a></p>
                <!-- /FORUM CATEGORY LINK -->
  
                <!-- FORUM CATEGORY LINK -->
                <p class="forum-category-link"><a href="forums-category.php">Anime &amp; Manga</a></p>
                <!-- /FORUM CATEGORY LINK -->
              </div>
              <!-- /FORUM CATEGORY INFO -->
            </div>
        ...
        <div class="table-row big">
          ...
          <div class="table-column">
            ...
            <div class="forum-category">
              ...
              <div class="forum-category-info">
                <!-- FORUM CATEGORY TITLE -->
                <p class="forum-category-title"><a href="forums-category.php">Live Streamers Unite!</a></p>
                <!-- /FORUM CATEGORY TITLE -->
          ...
          <div class="table-column padded-big-left">
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">Starting your stream? Here are some tips for you!</a>
            <!-- /TABLE LINK -->
  
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">Charity Runs: Complete list of upcoming charity runs streams</a>
            <!-- /TABLE LINK -->
  
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">What do you think about the newest "CaptainS" rebranding?</a>
            <!-- /TABLE LINK -->
          </div>
          <!-- /TABLE COLUMN -->
        </div>
        ...
        <div class="table-row big">
          ...
          <div class="table-column">
            ...
            <div class="forum-category">
              ...
              <div class="forum-category-info">
                <!-- FORUM CATEGORY TITLE -->
                <p class="forum-category-title"><a href="forums-category.php">The Jukebox</a></p>
                <!-- /FORUM CATEGORY TITLE -->
          ...
          <div class="table-column padded-big-left">
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">Ju Fighters will tour North America in Q4 2020</a>
            <!-- /TABLE LINK -->
  
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">Recommend a song for...commuting to work (GAME)</a>
            <!-- /TABLE LINK -->
  
            <!-- TABLE LINK -->
            <a class="table-link" href="forums-discussion.php">I'm selling my Flying X guitar. Come and take a look!</a>
            <!-- /TABLE LINK -->
          </div>
          <!-- /TABLE COLUMN -->
        </div>
